...
const ManualBooking = () => {
  ...
  const { postData, loadingPost, response } = usePost({
    url: "https://travelta.online/agent/manual_booking",
  });
  const auth = useAuth();
  ...
  useEffect(() => {
    ...
    const calculatedMarkupValue =
      isMarkupPercentage === 1
