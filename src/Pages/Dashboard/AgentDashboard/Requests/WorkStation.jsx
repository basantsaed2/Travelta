...
const WorkStation = () => {
  ...
  const handleMenuClick = () => {
    setMenuOpen(menuOpen === "negotiation" ? null : "negotiation");
  };
  ...
  return (
    <div className="p-6">
      ...
      <div className="grid grid-col-1 md:grid-cols-3 lg:grid-col-3 sm:grid-col-1  gap-4 mt-6">
        ...
        <div className="bg-white shadow-lg rounded-lg p-4">
              {/* Menu Icon */}
              <div className="flex justify-between items-center">   <button onClick={handleMenuClick} className="text-xl text-gray-600 hover:text-gray-800">
        &#9776; {/* Hamburger menu icon */}
      </button>
          <h3 className="text-xl font-semibold">Pending</h3></div>
    ...
    <p className="text-gray-700"><strong>To Phone:</strong> {card.to_phone}</p>
        ...
        {/* Price Quotation Card */}
        <div className="bg-white shadow-lg rounded-lg p-4">
                     {/* Menu Icon */}
                     <div className="flex justify-between items-center">   <button onClick={handleMenuClick} className="text-xl text-gray-600 hover:text-gray-800">
        &#9776; {/* Hamburger menu icon */}
      </button>
      <h3 className="text-xl font-semibold">Price Quotation</h3></div>
    ...
    <p className="text-gray-700"><strong>To Phone:</strong> {card.to_phone}</p>
     ...
     <div className="bg-white shadow-lg rounded-lg p-4 relative">
      ...
      <div className="flex justify-between items-center">
        ...
        <button onClick={handleMenuClick} className="text-xl text-gray-600 hover:text-gray-800">
          &#9776; {/* Hamburger menu icon */}
        </button>
      </div>

      {/* Dropdown Menu */}
      {menuOpen === "negotiation" && (
