...
const VisaTable = ({ data = [], loading, refetch, priorityOptions = [], stageOptions = [], isHistory = false }) => {
  ...
  useEffect(() => {
    ...
    // Apply date range filter using travel_date
    if (startDate || endDate) {
      result = result.filter(r => {
        ...
        const afterStart = !start || travelDateObj >= start;
        const beforeEnd = !end || travelDateObj <= end;
        ...
        <table className="w-full min-w-[600px]">
          <thead className="bg-gray-200 text-gray-700">
            <tr className="border-t-2 border-b-2">
              ...
              {["Client Name", "Client Phone", "Agent", "Revenue", "Country", "Travel Date", "Appointment Date", "Priority", "Stage", "Notes", "Actions"].map((name, index) => (
                <th
                  key={index}
                  className="min-w-[120px] text-mainColor bg-mainBgColor text-center font-medium sm:text-sm lg:text-base py-3 border-b-2"
                >
                  {name}
                </th>
              ))}
            ...
            {paginatedData.length === 0 ? (
              ...
              paginatedData.map((row, index) => (
                ...
                >
                  ...
                  <td className="text-center py-2 text-gray-600">{row.country_name || "-"}</td>
                  <td className="text-center py-2 text-gray-600">{row.travel_date || "-"}</td>
                  <td className="text-center py-2 text-gray-600">{row.appointment || "-"}</td>
              ...
              <DialogPanel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                <div className="flex flex-col items-center justify-center bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                  ...
                  <div className="mt-2 text-center">
                    You will delete {data.find(r => r.id === openDelete)?.to_name || "this visa"}
                  </div>
                </div>
              ...
              <div className="mt-4 space-y-6">
                <div>
                  ...
                  <input
                    ...
                    required
                  />
                  <p className="mt-1 text-sm text-gray-500">Please enter the visa confirmation code</p>
                </div>
              ...
              <div className="mt-4 space-y-6">
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="Explain why this visa application was lost..."
                    required
                  />
...
const VisaRequest = () => {
  ...
  const loading = loadingVisa || loadingList;
  const currentData = Visa?.current?.visas || [];
  const historyData = Visa?.history?.visas || [];
