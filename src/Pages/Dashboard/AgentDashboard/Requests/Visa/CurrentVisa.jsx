...
const CurrentVisa = ({ data, loading }) => {
  ...
  {filteredData.length > 0 ? (
    filteredData.slice(0, rowsToDisplay).map((row, index) => (
      <tr key={index} className="even:bg-gray-100 text-sm sm:text-base">
        ...
        <td className="p-3 border border-gray-300">{row.appointment || "N/A"}</td>
        <td className="p-3 border border-gray-300">{row.travel_date || "N/A"}</td>
        <td className="p-3 border border-gray-300">{row.currecy}</td>
        <td className="p-3 border border-gray-300">{row.country_name || "N/A"}</td>
        ...
        <td className="p-3 border border-gray-300">{row.visa_notes || "N/A"}</td>
      </tr>
    ))
  ) : (
    <tr>
