...
const AddCategoryRevenuePage = ({ update, setUpdate }) => {
    const { refetch: refetchCategory,loading:loadingCategory, data: DataCategory } = useGet({url: `https://travelta.online/agent/accounting/revenue/category`,});
    const { postData, loadingPost, response } = usePost({ url: 'https://travelta.online/agent/accounting/revenue/category/add' });
    ...
    const handleReset = () => {
     ...
     useEffect(() => {
        ...
        const handleSubmit = async (e) => {
            ...
            postData(formData, "Category added successful")
        };
...
export default AddCategoryRevenuePage;
