...
const EditCategoryRevenuePage = ({ update, setUpdate }) => {
    ...
    const { postData, loadingPost, response } = usePost({ url: `https://travelta.online/agent/accounting/revenue/category/update/${category?.id}` });
...
export default EditCategoryRevenuePage;
