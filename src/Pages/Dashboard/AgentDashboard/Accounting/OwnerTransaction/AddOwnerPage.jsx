...
const AddOwnerPage = ({ update, setUpdate }) => {
    const { postData, loadingPost, response } = usePost({ url: 'https://travelta.online/agent/accounting/owner/add' });
    ...
    const handleSubmit = async (e) => {
        ...
        postData(formData, 'Owner Added Success');
    };
