...
const OwnerTransactionPage = ({ update, setUpdate }) => {
  ...
  useEffect(() => {
    if (transactionData && transactionData.transactions && transactionData.owners) {
      console.log("Transaction Data:", transactionData);
      setTransactions(transactionData.transactions);
      setFilteredTransactions(transactionData.transactions); // Default to full dataset
      setOwners(transactionData.owners);
    }
  }, [transactionData]);
  ...
  useEffect(() => {
    ...
    if (searchText) {
      filtered = filtered.filter(transaction =>
        transaction?.owner?.name?.toLowerCase().includes(searchText) ||
