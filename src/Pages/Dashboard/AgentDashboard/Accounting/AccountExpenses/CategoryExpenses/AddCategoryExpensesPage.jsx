...
const AddCategoryExpensesPage = ({ update, setUpdate }) => {
    ...
    const { postData, loadingPost, response } = usePost({ url: 'https://travelta.online/agent/accounting/expenses/category/add' });
...
export default AddCategoryExpensesPage;
