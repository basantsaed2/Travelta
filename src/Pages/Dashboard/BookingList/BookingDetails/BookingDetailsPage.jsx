...
const BookingDetailsPage = () => {
    ...
    const { postData:postTask, loadingPost:loadingTask, response:responseTask} = usePost({ url: `https://travelta.online/agent/booking/confirmation_task/${detailsId}`});
          ...
          <div className="absolute top-5 left-10 right-10 h-1 bg-gray-200 z-0">
            <div 
              className={`h-full transition-all duration-500 ${
                item.status === "pending" ? "bg-emerald-500 w-0" :
                  ...
                  <nav className="flex overflow-x-auto no-scrollbar">
                      {tabs.map((tab) => (
                          <button
                              ...
                              className={`flex-shrink-0 py-3 px-4 border-b-2 font-medium text-sm flex items-center ${
                                  activeTab === tab.id
