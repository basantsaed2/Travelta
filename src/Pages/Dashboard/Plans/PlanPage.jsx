...
//   if (selectedPlan) {
//       const selectedPlanId = plans.find((plan) => plan.id == selectedPlanId);
//       if (selectedPlanId) {
//           dispatch(addToCart(selectedPlanId));
//       }
//   }
// }, [selectedPlan, plans, dispatch]); // Ensure to run only when selectedPlanId or plans change


  return (
    <>
      <nav className="bg-mainColor shadow-md px-4 py-2 flex justify-between items-center">
                  ...
                  <div className="text-center mt-8 mb-4">
                    {selectedPlan == plan.id ? (
                      <div className="flex justify-center space-x-4">
                        ...
                        <button
                          className="bg-blue-500 text-white px-4 py-2 rounded-full w-full transition duration-300 transform hover:scale-105 hover:bg-opacity-90 text-lg font-semibold shadow-lg"
                        >
                          Go to Cart
                        </button>
                      </div>
