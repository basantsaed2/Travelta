...
const SignUpFreelancer = () => {
  ...
  return (
    <div className="sign-up-page flex flex-col items-center justify-center lg:justify-around w-full xl:h-screen lg:h-full text-secoundColor">
        <h2 className="p-4 pb-0 text-3xl font-semibold text-mainColor text-center mb-5">SignUp Freelancer</h2>
         ...
         <div className='w-full flex flex-col-reverse lg:flex-row items-center justify-center lg:justify-around w-full'>
            ...
            <form className='w-full xl:w-3/4' onSubmit={handleSubmit}>
                ...
                <label className="text-black text-l font-semibold">Upload Passport Image : </label>
                <InputCustom
                ...
                <>
                <div className="w-full flex flex-col gap-1">
                <label className="text-black text-l font-semibold">Upload Front Image of National ID : </label>
                    <InputCustom
                    label="Upload Front Image of National ID"
                    type="file"
                    onChange={(e) => handleFileChange(e, setNationalImage1)}
                    />
                  <label className="text-black text-l font-semibold">Upload Back Image of National ID : </label>
                    <InputCustom
                    label="Upload Back Image of National ID"
                    type="file"
