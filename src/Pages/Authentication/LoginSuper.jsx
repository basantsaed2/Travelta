...
const LoginSuper = () => {
  ...
  useEffect(() => {
    if (userData && userType === 'SuperAdmin') {
      ...
      // Clear invalid user data for SuperAdmin login
      setUserData(null);
      setUserType('');
      auth.logout();
      navigate('/', { replace: true });
    }
  }, [userData, userType, auth, navigate]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://www.travelta.online/api/login', formData, {
        headers: {
